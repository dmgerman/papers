...
1. *cregit : Token-level Blame Information in git Version Control Repositories* @@html:<br>@@
   Daniel M. German, Bram Adams and Kate Stewart@@html:<br>@@
   Under review.@@html:<br>@@
   [[https://github.com/dmgerman/papers/raw/master/to-appear/emse-cregit/cregit.pdf][Local Copy]]


1. *Open Source Ecosystems and their need for a legal framework* @@html:<br>@@
   A book chapter @@html:<br>@@
   Daniel M. German @@html:<br>@@
   [[https://github.com/dmgerman/papers/raw/master/to-appear/ecoLicense.pdf][Local copy]]
...
1. *What Makes a Great Manager of Software Engineers?* @@html:<br>@@
   ...
   Transactions of Software Engineering.  Volume: 45 , Issue: 1 , Jan. 1 2019, Pages: 86-106<br>@@
   [[http://ieeexplore.ieee.org/abstract/document/8094304/][Publisher's copy]] | [[https://github.com/dmgerman/papers/raw/master/2019/tse-seng_manager/tse-seng-manager.pdf][Local copy]]
...
1. *Do developers update their library dependencies? - An empirical study on the impact of security advisories on library migration* @@html:<br>@@
   Raula Gaikovina Kula, Daniel M. German, Ali Ouni, Takashi Ishio and Katsuro Inoue. @@html:<br>@@
