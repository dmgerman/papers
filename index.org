...
1. *Was my contribution fairly reviewed?'' A framework to study perception of fairness in Modern Code Reviews* @@html:<br>@@
   ...
   [[https://github.com/dmgerman/papers/raw/master/2018/conferences/icse/icse2018-fairness.pdf][Local copy]]
...
1. *A Generalized Model for Visualizing Library Popularity, Adoption, and Diffusion within a Software Ecosystem* @@html:<br>@@
   ...
   IEEE International Conference on Software Analysis, Evolution and Reengineering (SANER'18).  Acceptance rate: 27% (39 out of 146 full papers). To appear.
